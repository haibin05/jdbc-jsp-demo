...
<%!
    ...
    public static final String DBURL = "jdbc:mysql://mysql_host:3306/WEBPLUSPRO_1";//数据库连接地址
    public static final String DBUSER = "idsv";//数据库连接用户名
    public static final String DBPASS = "ids#view@58";//数据库连接密码
%>
